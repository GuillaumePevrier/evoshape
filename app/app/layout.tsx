      ...
      <header className="sticky top-0 z-20 border-b border-[var(--border)] bg-[var(--surface)]/90 backdrop-blur">
        <div className="mx-auto flex w-full max-w-6xl items-center justify-between px-5 py-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <MobileNav items={navItems} unreadCount={unreadCount} />
          </div>
        </div>
      </header>

      <div className="mx-auto flex w-full max-w-6xl flex-col gap-6 px-5 pt-6 md:flex-row">
        <aside className="hidden w-full flex-col gap-3 md:sticky md:top-24 md:flex md:w-52 md:self-start">
        ...
        <main className="min-h-[70vh] flex-1 rounded-[32px] border border-[var(--border)] bg-white/80 p-5 shadow-[0_30px_80px_rgba(17,16,14,0.08)] sm:p-6">
          {children}
        </main>
      </div>
